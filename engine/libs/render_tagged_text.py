...
def render_tagged_text(text, w, h, tags, fgcolor=(0,0,0), bgcolor=(255,255,255), _defaultspace=4, line_spacing=0, justification=0):
    ...
    for line in actual_lines:
        ...
        if justification == 0: #left
            line_rect.left = finalrect.left
        elif justification == 1: #center
            line_rect.centerx = finalrect.centerx
        elif justification == 2: #right
            line_rect.right = finalrect.right
        else:
            TaggedTextException("Invalid justification argument")
        finalsurf.blit(line_surf,line_rect)
